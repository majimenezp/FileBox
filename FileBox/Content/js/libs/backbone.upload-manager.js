    ...
    Backbone.UploadManager = Backbone.DeferedView.extend({
        ...
        defaults: {
            templates: {
                ...
                file: { name: '/templates/upload-manager.file.default', onUploadDone:null}
            },
            uploadUrl: '/upload',
            autoUpload: false
        },
        ...
        FileView: Backbone.DeferedView.extend({
            ...
            initialize: function () {
                this.templateName = this.options.templates.file.name;
            ...
            {
                $('span.message', this.el).html('<i class="glyphicon glyphicon-remove"></i> ' + error);
            },
            ...
            {
                $('span.message', this.el).html('<i class="glyphicon glyphicon-ok"></i> ' + uploadedMessage);
                if (this.options.templates.file.onUploadDone != null) {
                    this.options.templates.file.onUploadDone(result, this.el);
                }
